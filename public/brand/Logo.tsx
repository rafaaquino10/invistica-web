...
const Wordmark: React.FC<{ fontSize: number; className?: string }> = ({ fontSize, className }) => (
  ...
  >
    ...
    <span className="text-foreground" style={{ color: 'var(--logo-text-color, #0F2B46)' }}>-Invest</span>
  </span>
);
...
export { Symbol, Wordmark, Tagline };
export default Logo;
 ...
 * }
 * 
 * Don't forget to import Outfit font:
