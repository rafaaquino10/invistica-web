...
@Component({
  ...
  `,
  styles: [`
    .section { padding: 80px 32px; background: #050505; display: flex; justify-content: center; }
    .section.in-view .cta-card { opacity: 1; transform: scale(1); }
    .cta-card {
      padding: 48px; text-align: center; border-radius: 4px; border: 1px solid rgba(208,243,100,0.12);
      max-width: 500px; width: 100%; display: flex; flex-direction: column; align-items: center; gap: 12px;
    ...
    .btn-volt { padding: 14px 40px; background: #d0f364; color: #050505; border-radius: 4px; font-weight: 700; font-size: 15px; margin-top: 8px; }
  `]
})
