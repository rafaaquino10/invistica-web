...
const COLUMN_CONFIG: Record<ColumnKey, {
  ...
  scoreTotal:             { label: 'aQ Score',      align: 'center',  glossaryKey: 'aQ Score' },
...
export default function ExplorerPage() {
  ...
  const handleExportCSV = () => {
    ...
    const colLabels: Record<string, string> = {
      ...
      scoreTotal: 'aQ Score', peRatio: 'P/L', pbRatio: 'P/VP', roe: 'ROE %',
    ...
    a.href = url
    a.download = `aqinvest-explorer-${new Date().toISOString().split('T')[0]}.csv`
    a.click()
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-[var(--text-caption)] text-[var(--text-3)] px-1">
        aQ Intelligence™ — Score = Valuation 25% + Qualidade 25% + Risco 20% + Dividendos 15% + Crescimento 15% · Fonte: CVM + brapi · 100% ações brasileiras
      </p>
