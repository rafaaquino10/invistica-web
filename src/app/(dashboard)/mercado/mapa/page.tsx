    ...
    <div className="space-y-6">
          ...
          {data && (
            <p className="text-[var(--text-small)] text-[var(--text-2)]">
              ...
              {data.totals.averageScore !== null && (
                <> {' · '} aQ Score médio: <span className="font-mono font-semibold">{data.totals.averageScore}</span></>
              )}
            </p>
          )}
        </div>
      ...
      {data && summary && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          ...
          {/* Average Score */}
          <div className="bg-[var(--surface-1)] border border-[var(--border-1)] rounded-lg shadow-sm px-4 py-3">
            <p className="text-[var(--text-caption)] text-[var(--text-3)] uppercase tracking-wider mb-1">aQ Score Médio</p>
