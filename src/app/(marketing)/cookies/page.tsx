...
const cookieCategories = [
  {
    ...
    required: true,
    cookies: [
      { name: 'aq-session', purpose: 'Manter sessão de login', duration: '7 dias' },
          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-[var(--text-2)]">
                ...
                <a href="mailto:privacidade@aqinvest.com.br" className="text-amber hover:underline font-medium">
