...
const TERMS: GlossaryTerm[] = [
  ...
  // Geral
  { term: 'aQ Score', category: 'geral', definition: 'Nota de 0 a 100 que avalia a saúde financeira de uma ação em 6 dimensões: Valuation, Qualidade, Risco, Dividendos, Crescimento e Qualitativo (moat, earnings quality, Z-Score).' },
  { term: 'Score X-Ray', category: 'geral', definition: 'Visualização detalhada de todas as 18+ sub-notas que compõem o aQ Score, incluindo pesos setoriais e ajustes aplicados.' },
